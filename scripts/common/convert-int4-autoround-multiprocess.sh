...
#   bash convert-int4-autoround-multiprocess.sh apetersson/DeepSeek-V4-Flash-0731-Abliterated-FP8
#
#   # Specific GPUs (0 and 2 only)
#   bash convert-int4-autoround-multiprocess.sh apetersson/DeepSeek-V4-Flash-0731-Abliterated-FP8 --gpus 0,2
#
#   # Quick test (fewer iterations, fewer samples)
#   bash convert-int4-autoround-multiprocess.sh apetersson/DeepSeek-V4-Flash-0731-Abliterated-FP8 --iters 200 --samples 32
#
# Options:
