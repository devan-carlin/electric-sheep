...
| 3 | `03-heretic-abliteration-on-xpu.md` | Removing a model's refusals without fine-tuning, on consumer Intel GPUs. |
...
- The abliteration process is documented in `~/neon-demon/HERETIC-PROCESS.md`.
