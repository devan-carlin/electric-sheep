...
// nsycl::artifact - .ninfer v2 container reader.
//
// Faithful port of ninfer/src/artifact/reader.h (CUDA/Windows reference) to the
// SYCL engine. POSIX-only. The container format is device-agnostic, so the
// reader ports cleanly.
