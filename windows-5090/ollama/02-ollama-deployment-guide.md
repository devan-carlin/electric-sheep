...
FROM "C:\path\to\gemma-4-26B-A4B-it-qat-q4_0---NVFP4.gguf"

# Load the vision projector via ADAPTER
ADAPTER "C:\path\to\gemma-4-26B-A4B-it-qat-q4_0---mmproj-BF16.gguf"
...
FROM "C:\path\to\Qwen3.6-35B-A3B---Native-MTP-Preserved-Q4_K_S.gguf"

# Point to the high-fidelity BF16 vision projector
FROM "C:\path\to\Qwen3.6-35B-A3B---Native-MTP-Preserved-mmproj-BF16.gguf"
