...
$BuildRoot = Join-Path $WorkspaceRoot "code"
$ModelsDir = "E:\llama.cpp\models"
...
Write-Host "     powershell -ExecutionPolicy Bypass -File `"$PSScriptRoot\..\scripts\Start-Llama-Server.ps1`""
Write-Host ""
