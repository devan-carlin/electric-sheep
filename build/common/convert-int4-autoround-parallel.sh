...
#   bash 04.1-convert-int4-autoround.sh apetersson/DeepSeek-V4-Flash-0731--FP8
#
#   # Parallel mode — all 4 GPUs, 24 CPU threads
#   bash 04.1-convert-int4-autoround.sh apetersson/DeepSeek-V4-Flash-0731--FP8 --parallel
#
#   # Parallel with custom batch size (4 layers concurrent)
#   bash 04.1-convert-int4-autoround.sh apetersson/DeepSeek-V4-Flash-0731--FP8 --parallel --batch-size 4
#
# Options:
