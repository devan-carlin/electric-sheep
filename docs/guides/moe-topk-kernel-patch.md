...
| Model | Huihui-CyberStrike-OffSec-35B-abliterated (Qwen3.5 MoE, 256 experts, 40 layers, ~67 GB) |
...
When benchmarking the Huihui-CyberStrike MoE model, we wanted to compare different `num_experts_per_tok` variants:
