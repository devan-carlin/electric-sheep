...
**Date:** 2026-08-10  
**Model:** `apetersson/DeepSeek-V4-Flash-0731-Abliterated-DS4-Quality128` (GGUF)  
**Hardware:** Threadripper PRO 3945WX, 247 GiB RAM, 4× Intel Arc Pro B70 (31.89 GiB each)  
**llama.cpp:** b10331 (SYCL/XPU backend)  
**Goal:** Serve a 304B MoE model (uncensored/abliterated) on Intel GPUs via llama.cpp
...
| File | Size | SHA256 |
|------|------|--------|
| `DeepSeek-V4-Flash-0731-Abliterated-DS4-Quality128.gguf` | 102.8 GB | `2cfc36b7...` |
| `DeepSeek-V4-Flash-0731-Abliterated-DS4-Quality128-llamacpp-DSpark-support.gguf` | 7.3 GB | `0582de4d...` |
...
- Uncensored/abliterated variant of DeepSeek-V4-Flash
...
cd ~/llama.cpp/build
./bin/llama-server \
  -m ~/electric-sheep/models/DeepSeek-V4-Flash-0731-Abliterated-DS4-Quality128/DeepSeek-V4-Flash-0731-Abliterated-DS4-Quality128.gguf \
  --host 0.0.0.0 \
  --port 8080 \
  --gpu-layers 999 \
  --flash-attn on \
