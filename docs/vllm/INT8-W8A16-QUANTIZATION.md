...
**Result for -ara:** 400 tensors packed, 31.62 GB (from 52 GB bf16).
...
| Config | tok/s | Notes |
|--------|-------|-------|
| INT8 W8A16 -ara, TP=4, **cudagraph ON** (main venv) | **47.80** | 512 tokens, 10.71 s. The target. |
| INT8 W8A16 -ara, TP=4, cudagraph OFF (main venv) | 19.58 | Same run without the env vars — shows the 2.4× gap. |
