#!/usr/bin/env bash
# =============================================================================
# start-qwen256k-vllm.sh - serve Qwen3.8-Flash-Next (W4A16) via vLLM on 4 GPUs
#
...
#
# Usage:
#   bash start-qwen256k-vllm.sh          # start (kills any existing :8000 first)
#   bash start-qwen256k-vllm.sh stop     # stop
#   bash start-qwen256k-vllm.sh status   # check
#
