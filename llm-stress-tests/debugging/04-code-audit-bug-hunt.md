# Code Auditing — Subtle Bug & Race Condition Hunting

**Target Capability:** Code comprehension, logic analysis, restraint (fixing bugs without rewriting working code).

Generative models tend to completely rewrite code when asked to fix small bugs. Testing whether a model can pinpoint a single subtle issue without breaking surrounding architectural patterns is a strong test of reasoning.
