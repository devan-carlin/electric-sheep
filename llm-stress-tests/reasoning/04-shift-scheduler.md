# Constraint Satisfaction — Shift Scheduler

**Target Capability:** Multi-variable logic and negative constraints ("Do NOT...").

LLMs excel at language fluency but naturally struggle with constraint satisfaction problems (CSPs), especially when negative rules are involved.
