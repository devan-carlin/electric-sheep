#!/usr/bin/env bash
# Qwen 3.8 27B ARA INT4 (AutoRound W4A16) - official ARA abliterated model, quantized
...
MODEL_PATH="$HOME/electric-sheep/models/Qwen3.8-27B-heretic-ara-int4-AutoRound/Qwen3.8-27B-heretic-ara-w4g128"
