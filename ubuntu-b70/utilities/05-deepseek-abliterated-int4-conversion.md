# DeepSeek V4-Flash Abliterated — INT4 AutoRound Conversion Guide

**Source:** `apetersson/DeepSeek-V4-Flash-0731-Abliterated-FP8`  
**Output:** `~/electric-sheep/models/DeepSeek-V4-Flash-0731-Abliterated-FP8-int4-AutoRound/`  
...
This document covers the process of converting the DeepSeek V4-Flash Abliterated FP8 model to INT4 AutoRound format for vLLM deployment on Intel XPU hardware.
...
cd ~/electric-sheep/ubuntu-b70/utilities
...
ls -lh ~/electric-sheep/models/DeepSeek-V4-Flash-0731-Abliterated-FP8-int4-AutoRound/
```
...
```
~/electric-sheep/models/DeepSeek-V4-Flash-0731-Abliterated-FP8-int4-AutoRound/
├── config.json
├── tokenizer.json
...
vllm serve ~/electric-sheep/models/DeepSeek-V4-Flash-0731-Abliterated-FP8-int4-AutoRound \
...
curl http://localhost:8000/v1/chat/completions \
  ...
  -d '{
    "model": "DeepSeek-V4-Flash-0731-Abliterated-FP8-int4-AutoRound",
    "messages": [
...
./04-convert-int4-autoround.sh apetersson/DeepSeek-V4-Flash-0731-Abliterated-FP8 --iters 200
```
...
- [Source Model](https://huggingface.co/apetersson/DeepSeek-V4-Flash-0731-Abliterated-FP8)
