...
#!/usr/bin/env bash
# ============================================
# Convert Model to INT4 AutoRound
# ============================================
# Downloads a source model and quantizes it to
# INT4 AutoRound format using the auto-round library.
#
# Usage:
#   ./03-convert-int4-autoround.sh <huggingface-repo>
#   ./03-convert-int4-autoround.sh --help
#
# Examples:
#   ./03-convert-int4-autoround.sh apetersson/DeepSeek-V4-Flash-0731-Abliterated-FP8
#   ./03-convert-int4-autoround.sh meta-llama/Llama-3.3-70B-Instruct
#
# Requirements:
...
show_help() {
    ...
    echo ""
    echo "Convert a HuggingFace model to INT4 AutoRound format."
    echo ""
    echo "Arguments:"
...
export SOURCE_DIR OUTPUT_DIR BITS GROUP_SIZE SYMMETRIC CALIBRATION_SAMPLES CALIBRATION_DATASET
...
print("  Model loaded, starting quantization...")
...
print(f"  Output size: {total_size / (1024**3):.1f} GB")
PYEOF
